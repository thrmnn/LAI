...
\begin{figure}[ht!]
    ...
    \end{subfigure}
    \caption{\textbf{Hemispherical photography for LAI validation.} (a) Original hemispherical fisheye image capturing canopy gap structure. (b) Binarized image after thresholding for gap fraction analysis. LAI is computed via the Beer-Lambert law applied to canopy openness. Agreement between methods (Table~\ref{tab:Hemspherical_LAI}) confirms the physical validity of our voxelization-based LAI estimates.}
