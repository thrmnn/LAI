...
\title[Article Title]{Mapping Leaf Area Index (LAI) in Urban Forest}
...
\author{\fnm{Théo} \sur{Hermann}}\email{thermann@mit.edu}

\author{\fnm{Michiel} \sur{van Selm}}\email{mvanselm@mit.edu}

\author{\fnm{Titus} \sur{Venverloo}}\email{iauthor@gmail.com}

\author{\fnm{Fabio} \sur{Duarte}}\email{iiiauthor@gmail.com}

\author{\fnm{Carlo} \sur{Ratti}}\email{iauthor@gmail.com}
...
\clearpage
\input{supplement/supplementary-figures}
\input{supplement/supplementary-methods}
